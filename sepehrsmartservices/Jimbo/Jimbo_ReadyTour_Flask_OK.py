...
# Set window title
os.system("title Jimbo Ready Tour Flask")


base_url = "https://www.jimbo.ir"
cookies_file = "Jimbo_readyTour_cookies.json"
def create_cookie_with_selenium():
    ...
    with open("Jimbo_readyTour_cookies.json", "w") as file:
...
class JimbooTour:
    def __init__(self,source,target,start_date,night_count,adults):
        self.cookies_file = "Jimbo_readyTour_cookies.json"
        self.base_url = "https://www.jimbo.ir"
        self.city_mapping = {
...
# Flask route
@app.route('/jimbo_tours', methods=['GET'])
def jimbo_tours():
    try:
        ...
        jimboo = JimbooTour(source,target,start_date,night_count,adults)
        future = executor.submit(jimboo.get_tours,)
