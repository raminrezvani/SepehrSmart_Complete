...
def fetch_and_cache_response(full_url, serverparams, cache_key, priorityTimestamp, selected_port):
    ...
    if response.status_code == 200:
        ...
        # Return a JSON formatted error message so json.load can parse it
        error_data = {
            "status_code": response.status_code,
            "message": response.text  # You might also include a more detailed error message or traceback
        }
