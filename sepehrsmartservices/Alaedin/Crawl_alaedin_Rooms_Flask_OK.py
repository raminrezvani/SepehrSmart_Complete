...
def save_cookies_and_headers(output_file, headers, cookies):
    ...
    print(f"Successfully saved cookies and headers to '{output_file}'.")
...
def get_rooms():
    ...
    result = fetch_room_data(hotelCod, start_date, stay, priorityTimestamp, use_cache)
...
def fetch_room_data(hotelCod, start_date, stay,priorityTimestamp,use_cache):
    ...
    for i in range(10):
        try:
            ...
            global cookies_dict, request_headers
            ...
            print('Error on fetch_room_data:', e)
            time.sleep(3)
            continue
...
def initialize_app():
    global request_headers, cookies_dict
