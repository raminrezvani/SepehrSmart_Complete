...
class TourCollector:
    def __init__(self, source, target, start_date, night_count, hotel_star, adults=2):
        ...
        self.providers_template = [
            ...
            ("Tak Setareh", lambda s, t, sd, nc, a, i: Sepehr(s, t, sd, nc, cookie_data.TAK_SETAREH, "tak_setareh", adults=a)),
    ...
    def get_single_data(self, source, target, start_date, use_cache, iter):
        ...
        # Wait for tasks with a 35-second timeout
        done, not_done = wait(tasks.keys(), timeout=35)
        ...
        # Mark tasks that didn’t complete within 35 seconds
        for future in not_done:
            name = tasks[future]
            provider_status[name] = {"length": 0, "message": "Did not complete within 35 seconds"}
