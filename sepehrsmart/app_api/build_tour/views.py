...
class BuildTourApi(APIView):
    ...
    def post(self, request):
        ...
        fields = [
            ...
            {"key": "provider", "required": False, "format": "text"},
        ...
        # just for debugging
        print("\n\n----------------------------")
        print("\t\t/sepehrsmart/app_api/build_tour/views.py line 59 -> list_process_threads():", list_process_threads())
        print("----------------------------\n\n")

        # ---
        tour = BuildTour(source=source, target=target, start_date=start_date, end_date=end_date, adults=adults,
                        priorityTimestamp= priorityTimestamp, hotel_provider=provider)
        ...
        # just for debugging
        print("\n\n----------------------------")
        print("\t\t/sepehrsmart/app_api/build_tour/views.py line 84 -> list_process_threads():", list_process_threads())
        print("----------------------------\n\n")
