...
from app_crawl.cookie.get_cookie import (dayan_cookie, sepid_parvaz_cookie, mehrab_cookie, rahbal_cookie,
                                         ...
                                         hamood_cookie, darvishi_cooke, moeindarbari_cooke, iman_amin_ziba_gsm_cookie)
...
def get_instance(code):
    ...
    elif code == 'iman_amin_ziba_gsm':
        return iman_amin_ziba_gsm_cookie
...
class SepehrCookieAPI(APIView):
    ...
    def post(self, request):
        ...
        elif sepehr_name == "iman_amin_ziba_gsm":

            # # ==== Retrieve from Redis ========
            # if (iman_amin_ziba_gsm_cookie.GetCookie_FromDB(provider="iman_amin_ziba_gsm")):
            #     return True
            # # =====================================


            iman_amin_ziba_gsm_cookie.login_sepehr(recaptcha_value=recaptcha_code, provider_code="iman_amin_ziba_gsm", company=company)
            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="KIH")
            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="GSM")
            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="SYZ")
            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="MHD",SourceMabda="THR")  # baraye ashhad

            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="THR", SourceMabda="MHD")  # baraye ashhad
            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="IFN", SourceMabda="THR")  # baraye ashhad
            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="AZD", SourceMabda="THR")  # baraye ashhad
            iman_amin_ziba_gsm_cookie.get_tour_cookie(target="TBZ", SourceMabda="THR")  # baraye ashhad



            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='KIH')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='GSM')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='SYZ')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='MHD')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='THR')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='IFN')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='AZD')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='TBZ')


            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='AWZ')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='BND')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='ZBR')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='KER')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='KSH')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='RAS')
            iman_amin_ziba_gsm_cookie.get_hotel_cookie(target='SRY')


            # ---- insert into DB
            iman_amin_ziba_gsm_cookie.insertCookie_intoDB(provider="iman_amin_ziba_gsm")
            # --------------------

            # hamood_cookie.get_hotel_cookie(target="GSM")
            iman_amin_ziba_gsm_cookie.close_driver()
