...
executor = ThreadPoolExecutor(max_workers=50)  # 10 worker threads
...
def remoteRequest():
    ...
    while(True):
        ...
        try:
            ...
            result = exeRequest.future.result(timeout=24)  # Wait until the task is completed
        ...
        # delete exeRequest object to avoid memory leakage
        del exeRequest
